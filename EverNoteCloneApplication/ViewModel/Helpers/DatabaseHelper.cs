...
namespace EvernoteClone.ViewModel.Helpers
{
    public class DatabaseHelper
    {
        ...
        private static string dbPath = "https://notes-app-wpf-4cd71-default-rtdb.europe-west1.firebasedatabase.app/";
...
/*            List<T> items;
            ...
            using (var client = new HttpClient())
            {
                ...
                if (result.IsSuccessStatusCode)
                {
                    var obj = JsonConvert.DeserializeObject<Dictionary<string, T>>(jsonResult);
